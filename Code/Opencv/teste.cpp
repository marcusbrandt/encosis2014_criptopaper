...
vector<vector<locate> > listOfCharacters(string pathImage){
...
map<const int, vector<Point>, ltstr>  listOfCharactersAntigo(string pathImage){
 ...
 //   infile.open("./Files/teste.txt");    
    ...
    while(i<images.size()){
       ...
       // cout<< "Criptografando :: " << endl;
        ...
        float raz = (cryptMessage.size()/a.size()) ;
