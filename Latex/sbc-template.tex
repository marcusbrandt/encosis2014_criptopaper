...
\author{Marcus Antonio Grécia Brandt\inst{1}, Mikhail Yasha Ramalho \inst{1}, Adriano Mendes Gil\inst{2}}
...
\nextinstitute
 Instituto Nokia de Tecnologia\\
  Manaus -- AM -- Brazil
  \email{\{marcusbrandt, mikhailramalho\}@gmail.com, adriano.gil@indt.org.br}
}
